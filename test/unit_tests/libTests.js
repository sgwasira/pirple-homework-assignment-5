 ...
 */
 ...
 // The function sumTwoNumbers should return the sum between two valid numbers otherwise return undefined
 libTests['lib.sumTwoNumbers should return the sum between two valid numbers otherwise return undefined'] = function(done){
   assert.doesNotThrow(function(){
     var firstNumber = 2;
     var secondNumber = 4;
     var expectedSum = 6;

     var result = lib.sumTwoNumbers(firstNumber, secondNumber);
     assert.equal(typeof(result), 'number');
     assert.equal(result, 6);


     var resultInvalid = lib.sumTwoNumbers('str', secondNumber);
